...
// Warehouse Arrival Scan Limiter
export const warehouseArrivalLimiter = rateLimit({
  windowMs: 1 * 60 * 1000, // 1 minute
  max: 30, // 30 requests per minute per IP to prevent rapid firing abuse
  standardHeaders: true,
  legacyHeaders: false,
  message: { success: false, message: 'Too many scans. Please pause and try again later.' },
});
